    ...
    class Medical_Way_Social_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Social Icons Widget', 'medical-way-plus'),
            );
            parent::__construct('medical-way-social', esc_html__('MW: Social', 'medical-way-plus'), $opts);
        }
        ...
        function form($instance) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'medical-way-plus'); ?></label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
            </p>

            <?php if (!has_nav_menu('social')) : ?>
                <p>
                <?php esc_html_e('Social menu is not set. Please create menu and assign it to Social Theme Location.', 'medical-way-plus'); ?>
                </p>
                <?php endif; ?>
                <?php
            }
        ...
        class Medical_Way_Latest_News_Widget extends WP_Widget {
            ...
            function __construct() {
                $opts = array(
                    ...
                    'description' => esc_html__('Latest News Widget', 'medical-way-plus'),
                );

                parent::__construct('medical-way-latest-news', esc_html__('MW: Latest News', 'medical-way-plus'), $opts);
            }
            ...
            ?>
                    ...
                    <?php if (1 != $disable_excerpt) { ?>
                                            ...
                                            <?php if (1 != $disable_button) { ?>
                                                <a href="<?php the_permalink(); ?>" class="button cta-button cta-button-primary"><?php esc_html_e('Read More', 'medical-way-plus'); ?></a>
                                            <?php } ?>
                ...
                function form($instance) {
                    ...
                    ?>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'medical-way-plus'); ?></strong></label>
                        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
                    </p>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('post_category')); ?>"><strong><?php esc_html_e('Select Category:', 'medical-way-plus'); ?></strong></label>
            <?php
            $cat_args = array(
                'orderby' => 'name',
                'hide_empty' => 0,
                ...
                'show_option_all' => esc_html__('All Categories', 'medical-way-plus'),
            );
            wp_dropdown_categories($cat_args);
            ?>
                    </p>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('post_number')); ?>"><strong><?php esc_html_e('Number of Posts:', 'medical-way-plus'); ?></strong></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('exclude_categories')); ?>"><strong><?php esc_html_e('Exclude Categories:', 'medical-way-plus'); ?></strong></label>
                        ...
                        <small>
            <?php esc_html_e('Enter category id seperated with comma. Posts from these categories will be excluded from latest post listing.', 'medical-way-plus'); ?>	
                        </small>
                    </p>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('post_column')); ?>"><strong><?php esc_html_e('Number of Columns:', 'medical-way-plus'); ?></strong></label>
            <?php
            ...
            <?php esc_html_e('Excerpt Length:', 'medical-way-plus'); ?>
                        </label>
                    ...
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('disable_excerpt'); ?>"><?php esc_html_e('Hide Excerpt', 'medical-way-plus'); ?></label>
                    </p>
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('disable_button'); ?>"><?php esc_html_e('Hide Read More Button', 'medical-way-plus'); ?></label>
                    </p>
            <?php
        }
    ...
    class Medical_Way_CTA_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Call To Action Widget', 'medical-way-plus'),
            );
            parent::__construct('medical-way-cta', esc_html__('MW: CTA', 'medical-way-plus'), $opts);
        }
        ...
        function form($instance) {
            ...
            $instance = wp_parse_args((array) $instance, array(
                'cta_page' => '',
                'button_text' => esc_html__('Find More', 'medical-way-plus'),
                'button_url' => '',
                    ));
            ?>
                    <p>
                        <label for="<?php echo $this->get_field_id('cta_page'); ?>">
                            <strong><?php esc_html_e('CTA Page:', 'medical-way-plus'); ?></strong>
                        </label>
            <?php
            wp_dropdown_pages(array(
                ...
                'show_option_none' => esc_html__('&mdash; Select &mdash;', 'medical-way-plus'),
                    )
            );
            ?>
                        <small>
                        <?php esc_html_e('Title, Content and Featured Image of this page will be used here', 'medical-way-plus'); ?>	
                        </small>
                    </p>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>"><strong><?php esc_html_e('Button Text:', 'medical-way-plus'); ?></strong></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('button_url')); ?>"><strong><?php esc_html_e('Button URL:', 'medical-way-plus'); ?></strong></label>
    ...
    class Medical_Way_Services_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Display services.', 'medical-way-plus'),
            );
            parent::__construct('medical-way-services', esc_html__('MW: Services', 'medical-way-plus'), $opts);
        }
        ...
        function widget($args, $instance) {
            ...
            ?>
                        ...
                        <?php setup_postdata($post); ?>
                                                ...
                                                <?php if (1 == $detail_link) { ?>
                                                        <h4 class="services-item-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4><?php } else {
                                                    ?>
                                                        <h4 class="services-item-title"><?php the_title(); ?></h4><?php
                                                    }
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('service_page'); ?>">
                            <strong><?php esc_html_e('Service Page:', 'medical-way-plus'); ?></strong>
                        </label>
                    <?php
                    wp_dropdown_pages(array(
                    ...
                    ?>
                        <small>
                        <?php esc_html_e('Title and Content of this page will be used in left side of services section with form', 'medical-way-plus'); ?>	
                        </small>
                    </p>
                    ...
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('detail_link'); ?>"><?php esc_html_e('Enable link to detail page', 'medical-way-plus'); ?></label>
                    </p>
            ...
            for ($i = 1; $i <= $item_number; $i++) {
                ?>
                        <p>
                            <label for="<?php echo $this->get_field_id("item_id_$i"); ?>"><strong><?php esc_html_e('Page:', 'medical-way-plus'); ?>&nbsp;<?php echo $i; ?></strong></label>
                <?php
                wp_dropdown_pages(array(
                ...
                ?>
                    ...
                    <?php esc_html_e('Appointment Form:', 'medical-way-plus'); ?>
                        </label>
                        ...
                        <small>
            <?php esc_html_e('Shortcode of Contact Form 7, Gravity From, Wufoo Form and other form is supproted.', 'medical-way-plus'); ?>	
                        </small>	
                    </p>
                    ...
                    class Medical_Way_Departments_Widget extends WP_Widget {
                        ...
                        function __construct() {
                            $opts = array(
                                ...
                                'description' => esc_html__('Display Departments, Description and Image.', 'medical-way-plus'),
                            );
                            parent::__construct('medical-way-departments', esc_html__('MW: Departments', 'medical-way-plus'), $opts);
                        }
                                        ...
                                        <?php foreach ($all_departments as $post) : ?>
                                            <?php setup_postdata($post); ?>
                                                <div class="department-item">
                                                    <h4 class="department-item-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
                                            <?php
                                            $content = medical_way_get_the_excerpt(absint($excerpt_length), $post);
            ...
            <?php if (!empty($department_src[0])) : ?>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('department_page'); ?>">
                            <strong><?php esc_html_e('Department Page:', 'medical-way-plus'); ?></strong>
                        </label>
                    <?php
                    wp_dropdown_pages(array(
                    ...
                    ?>
                        <small>
                        <?php esc_html_e('Title, Content and Featured Image of this page will be used in this section', 'medical-way-plus'); ?>	
                        </small>
                    </p>

                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('image_alignment')); ?>"><strong><?php _e('Select Image Position:', 'medical-way-plus'); ?></strong></label>
                        <?php
                ...
                ?>
                    ...
                    function dropdown_image_alignment($args) {
                        ...
                        $choices = array(
                            'left' => esc_html__('Left', 'medical-way-plus'),
                            'right' => esc_html__('Right', 'medical-way-plus'),
                        );
                ...
                class Medical_Way_Facts_Widget extends WP_Widget {
                    ...
                    function __construct() {
                        $opts = array(
                            ...
                            'description' => esc_html__('Display Fact counters.', 'medical-way-plus'),
                        );
                        parent::__construct('medical-way-facts', esc_html__('MW: Facts', 'medical-way-plus'), $opts);
                    }
            ...
            ?>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id("icon_one")); ?>"><strong><?php esc_html_e('Icon One:', 'medical-way-plus'); ?></strong></label>
                    ...
                    <?php esc_html_e('Count One:', 'medical-way-plus'); ?>
                        </label>
            ...
            <?php esc_html_e('Text One:', 'medical-way-plus'); ?>
                        </label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id("icon_two")); ?>"><strong><?php esc_html_e('Icon Two:', 'medical-way-plus'); ?></strong></label>
            ...
            <?php esc_html_e('Count Two:', 'medical-way-plus'); ?>
                        </label>
            ...
            <?php esc_html_e('Text Two:', 'medical-way-plus'); ?>
                        </label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id("icon_three")); ?>"><strong><?php esc_html_e('Icon Three:', 'medical-way-plus'); ?></strong></label>
            ...
            <?php esc_html_e('Count Three:', 'medical-way-plus'); ?>
                        </label>
            ...
            <?php esc_html_e('Text Three:', 'medical-way-plus'); ?>
                        </label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id("icon_four")); ?>"><strong><?php esc_html_e('Icon Four:', 'medical-way-plus'); ?></strong></label>
            ...
            <?php esc_html_e('Count Four:', 'medical-way-plus'); ?>
                        </label>
            ...
            <?php esc_html_e('Text Four:', 'medical-way-plus'); ?>
                        </label>
                    ...
                    <div class="cover-image">
                        <label for="<?php echo esc_attr($this->get_field_id('bg_pic')); ?>">
                            <strong><?php esc_html_e('Background Image:', 'medical-way-plus'); ?></strong>
                        </label>
                        ...
                        <div class="rtam-preview-wrap" <?php echo $wrap_style; ?>>
                            <img src="<?php echo esc_url($bg_pic); ?>" alt="<?php esc_attr_e('Preview', 'medical-way-plus'); ?>" />
                        </div><!-- .rtam-preview-wrap -->
                        <input type="button" class="select-img button button-primary" value="<?php esc_html_e('Upload', 'medical-way-plus'); ?>" data-uploader_title="<?php esc_html_e('Select Background Image', 'medical-way-plus'); ?>" data-uploader_button_text="<?php esc_html_e('Choose Image', 'medical-way-plus'); ?>" />
                        <input type="button" value="<?php echo esc_attr_x('X', 'Remove Button', 'medical-way-plus'); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr($delete_button); ?>" />
                    </div>
    ...
    class Medical_Way_Contact_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Display Contact Us section.', 'medical-way-plus'),
            );
            parent::__construct('medical-way-contact', esc_html__('MW: Contact', 'medical-way-plus'), $opts);
        }
        ...
        function widget($args, $instance) {
            ...
            ?>
                    ...
                    <?php esc_html_e('Form Shortcode:', 'medical-way-plus'); ?>
                        </label>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('contact_page'); ?>">
                            <strong><?php esc_html_e('Contact Page:', 'medical-way-plus'); ?></strong>
                        </label>
            <?php
            wp_dropdown_pages(array(
            ...
            ?>
                        <small>
                            <?php esc_html_e('Content of this page will be used in right side of form', 'medical-way-plus'); ?>	
                        </small>
                    </p>
                ...
                class Medical_Way_Team_Widget extends WP_Widget {
                    ...
                    function __construct() {
                        $opts = array(
                            ...
                            'description' => esc_html__('Display team section.', 'medical-way-plus'),
                        );
                        parent::__construct('medical-way-team', esc_html__('MW: Team', 'medical-way-plus'), $opts);
                    }
        ...
        function form($instance) {
            ...
            ?>
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('team_page'); ?>">
                            <strong><?php esc_html_e('Team Page:', 'medical-way-plus'); ?></strong>
                        </label>
                    <?php
                    wp_dropdown_pages(array(
                    ...
                    ?>
                        <small>
                    <?php esc_html_e('Sub Pages of this page will be listed as each team member', 'medical-way-plus'); ?>	
                        </small>
                    </p>
                ...
                class Medical_Way_Testimonial_Widget extends WP_Widget {
                    ...
                    function __construct() {
                        $opts = array(
                            ...
                            'description' => esc_html__('Display testimonial section.', 'medical-way-plus'),
                        );
                        parent::__construct('medical-way-testimonial', esc_html__('MW: Testimonial', 'medical-way-plus'), $opts);
                    }
                    ...
                    <p>
                        <label for="<?php echo $this->get_field_id('testimonial_page'); ?>">
                            <strong><?php esc_html_e('Testimonial Page:', 'medical-way-plus'); ?></strong>
                        </label>
                    <?php
                    wp_dropdown_pages(array(
                    ...
                    ?>
                        <small>
                    <?php esc_html_e('Sub Pages of this page will be listed as testimonials', 'medical-way-plus'); ?>	
                        </small>
                    </p>

                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('transition_effects')); ?>"><strong><?php _e('Transition Effect:', 'medical-way-plus'); ?></strong></label>
            <?php
            ...
            ?>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('transition_delay')); ?>"><strong><?php _e('Transition Delay:', 'medical-way-plus'); ?></strong></label>
                        ...
                        <small><?php _e('in seconds', 'medical-way-plus'); ?></small>
                    </p>

                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('transition_duration')); ?>"><strong><?php _e('Transition Duration:', 'medical-way-plus'); ?></strong></label>
                    ...
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('show_arrow'); ?>"><?php _e('Show Arrow', 'medical-way-plus'); ?></label>
                    </p>
                    ...
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('show_pager'); ?>"><?php _e('Show Pager', 'medical-way-plus'); ?></label>
                    </p>
                    ...
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('enable_autoplay'); ?>"><?php _e('Enable Autoplay', 'medical-way-plus'); ?></label>
                    </p>
        ...
        function dropdown_transition_effect($args) {
            ...
            $choices = array(
                'fade' => esc_html__('fade', 'medical-way-plus'),
                'fadeout' => esc_html__('fadeout', 'medical-way-plus'),
                'none' => esc_html__('none', 'medical-way-plus'),
                'scrollHorz' => esc_html__('scrollHorz', 'medical-way-plus'),
            );
