...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		...
		'primary_color',
		array(
			'label'       => __( 'Primary Color', 'medical-way-plus' ),
			'description' => __( 'Applied to main color of site.', 'medical-way-plus' ),
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		...
		'button_color',
		array(
			'label'       => __( 'Button Color', 'medical-way-plus' ),
			'description' => __( 'Applied to background color of buttons.', 'medical-way-plus' ),
...
//For button hover color options
$wp_customize->add_setting('button_hover', array(
	'default' 			=> $default['button_hover'],
	'sanitize_callback' => 'sanitize_hex_color'
));	
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		...
		'button_hover',
		array(
			'label'       => __( 'Button Hover Color', 'medical-way-plus' ),
			'description' => __( 'Applied to background color of buttons in mouse over.', 'medical-way-plus' ),
...
//For responsive menu hover color options
$wp_customize->add_setting('menu_hover', array(
	'default' 			=> $default['menu_hover'],
	'sanitize_callback' => 'sanitize_hex_color'
));	
...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		...
		'menu_hover',
		array(
			'label'       => __( 'Responsive Menu Hover Color', 'medical-way-plus' ),
			'description' => __( 'Applied to background color of responsive menu item in mouse over.', 'medical-way-plus' ),
			'settings'    => 'menu_hover',
			'section'     => 'colors',	
			'priority'	  => 100,			   
		)
...
$wp_customize->add_panel( 'theme_option_panel',
	array(
		'title'      => esc_html__( 'Theme Options', 'medical-way-plus' ),
		'priority'   => 100,
...
$wp_customize->add_section( 'section_header',
	array(
		'title'      => esc_html__( 'Header Options', 'medical-way-plus' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'show_title',
	array(
		'label'    => esc_html__( 'Show Site Title', 'medical-way-plus' ),
...
$wp_customize->add_control( 'show_tagline',
	array(
		'label'    => esc_html__( 'Show Tagline', 'medical-way-plus' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'top_address',
	array(
		'label'    => esc_html__( 'Top Address', 'medical-way-plus' ),
		'section'  => 'section_header',
		'type'     => 'text',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'top_phone',
	array(
		'label'    => esc_html__( 'Top Phone', 'medical-way-plus' ),
		'section'  => 'section_header',
		'type'     => 'text',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'top_fax',
	array(
		'label'    => esc_html__( 'Top Fax', 'medical-way-plus' ),
		'section'  => 'section_header',
		'type'     => 'text',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'show_social_icons',
	array(
		'label'    => esc_html__( 'Show social icons at right', 'medical-way-plus' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'enable_sticky',
        array(
                'label'           => esc_html__( 'Make Main Nav Sticky', 'medical-way-plus' ),
                'section'         => 'section_header',
                'type'            => 'checkbox',
                'priority'        => 100,
        )
...
$wp_customize->add_section( 'section_layout',
	array(
		'title'      => esc_html__( 'Blog Layout Options', 'medical-way-plus' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
		'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'global_layout',
	array(
		'label'    => esc_html__( 'Global Layout', 'medical-way-plus' ),
		'section'  => 'section_layout',
		'type'     => 'radio',
		'priority' => 100,
		'choices'  => array(
				'left-sidebar'  => esc_html__( 'Left Sidebar', 'medical-way-plus' ),
				'right-sidebar' => esc_html__( 'Right Sidebar', 'medical-way-plus' ),
				'no-sidebar'    => esc_html__( 'No Sidebar', 'medical-way-plus' ),
			),
	)
);
...
$wp_customize->add_control( 'excerpt_length',
	array(
		'label'       => esc_html__( 'Excerpt Length', 'medical-way-plus' ),
		'description' => esc_html__( 'number of words', 'medical-way-plus' ),
		'section'     => 'section_layout',
		'type'        => 'number',
		'priority'    => 100,
...
$wp_customize->add_control( 'posted_date',
	array(
		'label'           => esc_html__( 'Hide Posted Date', 'medical-way-plus' ),
		'section'         => 'section_layout',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'post_author',
	array(
		'label'           => esc_html__( 'Hide Author', 'medical-way-plus' ),
		'section'         => 'section_layout',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'post_category',
	array(
		'label'           => esc_html__( 'Hide Category', 'medical-way-plus' ),
		'section'         => 'section_layout',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'post_tag',
	array(
		'label'           => esc_html__( 'Hide Tags', 'medical-way-plus' ),
		'section'         => 'section_layout',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'post_comment',
	array(
		'label'           => esc_html__( 'Hide Comment', 'medical-way-plus' ),
		'section'         => 'section_layout',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_section( 'section_footer',
	array(
		'title'      => esc_html__( 'Footer Options', 'medical-way-plus' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
		'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'copyright_text',
	array(
		'label'    => esc_html__( 'Copyright Text', 'medical-way-plus' ),
...
$wp_customize->add_setting( 'powerby_text',
	array(
		'default'           => $default['powerby_text'],
		'sanitize_callback' => 'medical_way_sanitize_credit',
	)
);
$wp_customize->add_control( 'powerby_text',
	array(
		'label'    		=> __( 'Powerby Text', 'medical-way-plus' ),
		'description' 	=> __( 'This will override default powerby text in footer of theme. Leave empty if you like to hide powerby text.', 'medical-way-plus' ),
		'section'  		=> 'section_footer',
		'type'     		=> 'textarea',
		'priority' 		=> 100,
	)
...
$wp_customize->add_section( 'section_breadcrumb',
	array(
		'title'      => esc_html__( 'Breadcrumb Options', 'medical-way-plus' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
		'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'breadcrumb_type',
	array(
		'label'       => esc_html__( 'Breadcrumb Type', 'medical-way-plus' ),
		'section'     => 'section_breadcrumb',
		'type'        => 'radio',
		'priority'    => 100,
		'choices'     => array(
			'disable' 	=> esc_html__( 'Disable', 'medical-way-plus' ),
			'simple'  	=> esc_html__( 'Simple', 'medical-way-plus' ),
			'image-bg'  => esc_html__( 'Custom Background', 'medical-way-plus' ),
		),
	)
);
...
$wp_customize->add_control( 'breadcrumb_overlay_status',
	array(
		'label'           => __( 'Enable Overlay', 'medical-way-plus' ),
		'section'         => 'section_breadcrumb',
		'type'            => 'checkbox',
		'priority'        => 100,
...
$wp_customize->add_section( 'section_services',
	array(
		'title'      => esc_html__( 'Services Page Options', 'medical-way-plus' ),
		'priority'   => 100,
		'panel'      => 'theme_option_panel',
	)
);
...
$wp_customize->add_control( "services_page",
	array(
		'label'           => esc_html__( 'Services Page', 'medical-way-plus' ),
		'description' 	  => __( 'Sub Pages of this page will be listed as services', 'medical-way-plus' ),
...
$wp_customize->add_control( 'services_link',
	array(
		'label'    => esc_html__( 'Disable link to services detail page', 'medical-way-plus' ),
		'section'  => 'section_services',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'services_excerpt',
	array(
		'label'       => esc_html__( 'Excerpt Length', 'medical-way-plus' ),
		'description' => esc_html__( 'in words', 'medical-way-plus' ),
		'section'     => 'section_services',
		'type'        => 'number',
		'priority'    => 100,
...
$wp_customize->add_section( 'section_departments',
	array(
		'title'      => esc_html__( 'Departments Page Options', 'medical-way-plus' ),
		'priority'   => 100,
		'panel'      => 'theme_option_panel',
	)
);
...
$wp_customize->add_control( "departments_page",
	array(
		'label'           => esc_html__( 'Departments Page', 'medical-way-plus' ),
		'description' 	  => __( 'Sub Pages of this page will be listed as departments', 'medical-way-plus' ),
...
$wp_customize->add_control( 'departments_link',
	array(
		'label'    => esc_html__( 'Disable link to department detail page', 'medical-way-plus' ),
		'section'  => 'section_departments',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_section( 'section_team',
	array(
		'title'      => esc_html__( 'Team Page Options', 'medical-way-plus' ),
		'priority'   => 100,
		'panel'      => 'theme_option_panel',
	)
);
...
$wp_customize->add_control( "team_page",
	array(
		'label'           => esc_html__( 'Team Page', 'medical-way-plus' ),
		'description' 	  => __( 'Sub Pages of this page will be listed as each team member', 'medical-way-plus' ),
...
$wp_customize->add_control( 'member_link',
	array(
		'label'    => esc_html__( 'Disable link to member detail page', 'medical-way-plus' ),
		'section'  => 'section_team',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_panel( 'slider_option_panel',
	array(
		'title'      => esc_html__( 'Featured Slider Options', 'medical-way-plus' ),
		'priority'   => 100,
	)
);
...
$wp_customize->add_section( 'section_slider',
	array(
		'title'      => esc_html__( 'Slider Type', 'medical-way-plus' ),
		'priority'   => 100,
...
$wp_customize->add_control( 'slider_status',
	array(
		'label'       => esc_html__( 'Slider Status', 'medical-way-plus' ),
		'section'     => 'section_slider',
		'type'        => 'radio',
		'priority'    => 100,
		'choices'     => array(
			'disable' => esc_html__( 'Disable', 'medical-way-plus' ),
			'home'    => esc_html__( 'Multiple Slides', 'medical-way-plus' ),
		),
	)
);
...
$wp_customize->add_control( 'slider_excerpt_length',
	array(
		'label'       => __( 'Description Length', 'medical-way-plus' ),
		'description' => __( 'Applied to count of words used in description of all slides', 'medical-way-plus' ),
		'section'     => 'section_slider',
		'type'        => 'number',
		'priority'    => 100,
...
for ( $i = 1; $i <= $slider_number; $i++ ) {
	...
	$wp_customize->add_control( 
		new medical_way_Info( 
			...
			'slide_'.$i.'_info', 
			array(
				'label' 			=> esc_html__( 'Slide ', 'medical-way-plus' ) . ' - ' . $i,
				'section' 			=> 'section_slider',
				'priority' 			=> 100,
				'active_callback' 	=> 'medical_way_is_featured_slider_active',
			) 
	...
	$wp_customize->add_control( "slider_page_$i",
		array(
			'label'           => esc_html__( 'Select Slide', 'medical-way-plus' ),
			'section'         => 'section_slider',
			'type'            => 'dropdown-pages',
			'priority'        => 100,
			'active_callback' => 'medical_way_is_featured_slider_active',
	...
	$wp_customize->add_control( "slider_button_$i",
		array(
			'label'           => esc_html__( 'Button Text', 'medical-way-plus' ),
			'section'         => 'section_slider',
			'type'            => 'text',
			'priority'        => 100,
			'active_callback' => 'medical_way_is_featured_slider_active',
	...
	$wp_customize->add_control( "slider_url_$i",
		array(
			'label'           => esc_html__( 'Button Link', 'medical-way-plus' ),
			'section'         => 'section_slider',
			'type'            => 'text',
			'priority'        => 100,
			'active_callback' => 'medical_way_is_featured_slider_active',
...
$wp_customize->add_section( 'section_slider_options',
	array(
		'title'      => esc_html__( 'Slider Options', 'medical-way-plus' ),
		'priority'   => 100,
		'panel'      => 'slider_option_panel',
	)
);
...
$wp_customize->add_control( 'slider_transition_effect',
	array(
		'label'           => __( 'Transition Effect', 'medical-way-plus' ),
...
$wp_customize->add_control( 'slider_transition_delay',
	array(
		'label'           => __( 'Transition Delay', 'medical-way-plus' ),
		'description'     => __( 'in seconds', 'medical-way-plus' ),
		'section'         => 'section_slider_options',
		'type'            => 'number',
		'priority'        => 100,
...
$wp_customize->add_control( 'slider_transition_duration',
	array(
		'label'           => __( 'Transition Duration', 'medical-way-plus' ),
		'description'     => __( 'in seconds', 'medical-way-plus' ),
		'section'         => 'section_slider_options',
		'type'            => 'number',
		'priority'        => 100,
...
$wp_customize->add_control( 'slider_caption_status',
	array(
		'label'           => __( 'Show Caption', 'medical-way-plus' ),
		'section'         => 'section_slider_options',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'slider_arrow_status',
	array(
		'label'           => __( 'Show Arrow', 'medical-way-plus' ),
		'section'         => 'section_slider_options',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'slider_pager_status',
	array(
		'label'           => __( 'Show Pager', 'medical-way-plus' ),
		'section'         => 'section_slider_options',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_control( 'slider_autoplay_status',
	array(
		'label'           => __( 'Enable Autoplay', 'medical-way-plus' ),
		'section'         => 'section_slider_options',
		'type'            => 'checkbox',
		'priority'        => 100,
	)
...
$wp_customize->add_section( 'section_fonts',
	array(
		'title'      => __( 'Font Options', 'medical-way-plus' ),
		'priority'   => 100,
		'panel'      => 'theme_option_panel',
	)
);
...
$wp_customize->add_setting( 'font_name',
	array(
		'default'           => $default['font_name'],
		'sanitize_callback' => 'sanitize_text_field',
	)
);
$wp_customize->add_control( 'font_name',
	array(
		'label'    		=> esc_html__( 'Font Name', 'medical-way-plus' ),
		'description' 	=> esc_html__( 'Ex: Asap, Raleway, Roboto', 'medical-way-plus' ),
...
$wp_customize->add_setting( 'font_family',
	array(
		'default'           => $default['font_family'],
		'sanitize_callback' => 'sanitize_text_field',
	)
);
$wp_customize->add_control( 'font_family',
	array(
		'label'    		=> esc_html__( 'Font Family', 'medical-way-plus' ),
		'description' 	=> esc_html__( 'Ex: Asap:400,400i,500,500i,700,700i or Raleway:100,300,400,500,700,900 or Roboto:100,300,400,700', 'medical-way-plus' ),
		'section'  		=> 'section_fonts',
		'type'     		=> 'text',
		'priority' 		=> 100,
	)
