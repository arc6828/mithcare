                ...
                if ($departments_query->have_posts()) {
                    ...
                    while ($departments_query->have_posts()) {
                        ...
                        <div class="department-info department-top">
                            ...
                            wp_link_pages(array(
                                'before' => '<div class="page-links">' . esc_html__('Pages:', 'medical-way-plus'),
                                'after' => '</div>',
                            ));
                            ?>
                        </div>
        ...
        ?>
                        ...
                        <div class="department-item">
                            <?php if (has_post_thumbnail()) : ?>
                                ...
                                if (1 == $departments_link) {
                                    ?>
                                <h4 class="department-item-title"><?php the_title(); ?></h4><?php } else {
                                    ?>

                                <h4 class="department-item-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4><?php
                }
