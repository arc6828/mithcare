...
function medical_way_setup() {
	 ...
	 * to change 'medical-way-plus' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'medical-way-plus' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Navigation', 'medical-way-plus' ),
		'top'     => esc_html__( 'Top Navigation', 'medical-way-plus' ),
		'social'  => esc_html__( 'Social Links', 'medical-way-plus' ),
	) );
...
function medical_way_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'medical-way-plus' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here to appear in Sidebar.', 'medical-way-plus' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Home Page Widget Area', 'medical-way-plus' ),
		'id'            => 'home-page-widget-area',
		'description'   => esc_html__( 'Add widgets here to appear in Home Page Widget Area.', 'medical-way-plus' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => sprintf( esc_html__( 'Footer %d', 'medical-way-plus' ), 1 ),
		'id'            => 'footer-1',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => sprintf( esc_html__( 'Footer %d', 'medical-way-plus' ), 2 ),
		'id'            => 'footer-2',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h4 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => sprintf( esc_html__( 'Footer %d', 'medical-way-plus' ), 3 ),
		'id'            => 'footer-3',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h4 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => sprintf( esc_html__( 'Footer %d', 'medical-way-plus' ), 4 ),
		'id'            => 'footer-4',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h4 class="widget-title">',
...
function medical_way_scripts() {
	...
	wp_enqueue_script( 'medical-way-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '1.1.2', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
        
        $enable_sticky = medical_way_get_option('enable_sticky');
...
function medical_way_admin_scripts( $hook ) {
	...
	if( 'widgets.php' === $hook ){
		...
		wp_enqueue_style( 'medical-way-admin', get_template_directory_uri() . '/includes/widgets/css/admin.css', array(), '1.1.2' );

		wp_enqueue_media();

		wp_enqueue_script( 'medical-way-admin', get_template_directory_uri() . '/includes/widgets/js/admin.js', array( 'jquery' ), '1.1.2' );
