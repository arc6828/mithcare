...
if ( ! class_exists( 'Medical_Way_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Medical_Way_Demo {

		/**
		 * Singleton instance of Medical_Way_Demo.
		 *
		 * @var Medical_Way_Demo $instance Medical_Way_Demo instance.
		 */
		...
		/**
		 * Main Medical_Way_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Medical_Way_Demo ) ) {
				self::$instance = new Medical_Way_Demo();
